# Veracity Identity and Services

## Veracity.Common.Authentication

These packages provides the basic wrapper code for authentication and calling the Veracity api's. 
...
With the Veracity Services api V3 we are trying to make a unified and consistent vocabulary for interacting with Veracity identity and Services api. At the heart of the API lies a set of view-points that represents the data seen from an 
